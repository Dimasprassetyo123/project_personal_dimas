...
if (isset($_POST['tombol'])) {
    ...
    if (move_uploaded_file($imageOld, $storages . $imageNew)) {
        $qInsert = "INSERT INTO abouts(name, born, address, zip_code, email, phone, total_project, work, image, description) 
        VALUES( '$name', '$born', '$address', '$zip_code', '$email', '$phone', '$total_project', '$work', '$imageNew', '$description')";
